...
import com.example.finalrideapp.view.home.CreateTripActivity
...
class WelcomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //(activity as HomeActivity).navBar.menu.getItem(0).isChecked = true

        createTripButton.setOnClickListener {
            val intentCreateTrip = Intent(activity,
